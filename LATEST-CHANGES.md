...
## ترتيب تاسكات قاعدة البيانات حسب الأقسام
- ترتيب ملخص اليوزرات والجدول التفصيلي أصبح: قسم المحتوى، قسم المونتاج، قسم التصوير، قسم التصميم، ثم باقي الأقسام.
- عمود "التاسك" يعرض اسم الكرييتيف نفسه بدل اسم القسم أو نوع الفلو.
- داخل كل قسم يتم ترتيب الصفوف حسب تسلسل التاسك/الكرييتيف ثم اسم المسؤول.
- نفس الترتيب يُستخدم داخل نافذة تاسكات المسؤول.
- لم يتم تعديل الداش بورد أو نسب التقدم أو بيانات التاسكات.
