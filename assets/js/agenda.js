(function(){
  'use strict';
  const CREATIVE_MAP = [
    ['montage','قسم المونتاج','REEL - مواصفات كامله - STUDIO','M-RL-SPEC-ST'],['montage','قسم المونتاج','REEL - اهم المواصفات - STUDIO','M-RL-TOP-ST'],['montage','قسم المونتاج','REEL - SHORT/TREND - SHOWROOM','M-RL-TRD-SR'],['montage','قسم المونتاج','REEL - UGC - SHOWROOM','M-RL-UGC-SR'],['montage','قسم المونتاج','REEL - حملات - SHOWROOM','M-RL-CMP-SR'],['montage','قسم المونتاج','REEL - معارضنا - SHOWROOM','M-RL-SHOW-SR'],['montage','قسم المونتاج','REEL - تجربه عميل - SHOWROOM','M-RL-CUST-SR'],['montage','قسم المونتاج','VIDEO - مواصفات - STUDIO','M-VD-SPEC-ST'],['montage','قسم المونتاج','VIDEO - فيلم سياره - STUDIO','M-VD-CAR-ST'],['montage','قسم المونتاج','VIDEO - فيلم - STUDIO','M-VD-FILM-ST'],['montage','قسم المونتاج','VIDEO - مواصفات - SHOWROOM','M-VD-SPEC-SR'],['montage','قسم المونتاج','VIDEO - فيلم - SHOWROOM','M-VD-FILM-SR'],['montage','قسم المونتاج','VIDEO - معارضنا - SHOWROOM','M-VD-SHOW-SR'],['montage','قسم المونتاج','STORY - جاهزة الان - STUDIO','M-ST-READY-ST'],['montage','قسم المونتاج','STORY - سعرها اليوم - STUDIO','M-ST-PRICE-ST'],['montage','قسم المونتاج','STORY - قسطها الان - STUDIO','M-ST-INST-ST'],['montage','قسم المونتاج','STORY - معرضنا - SHOWROOM','M-ST-SHOW-SR'],['montage','قسم المونتاج','STORY - جاهزة الان - SHOWROOM','M-ST-READY-SR'],['montage','قسم المونتاج','STORY - سعرها اليوم - SHOWROOM','M-ST-PRICE-SR'],['montage','قسم المونتاج','STORY - قسطها الان - SHOWROOM','M-ST-INST-SR'],
    ['design','قسم التصميم','POST','D-POST'],['design','قسم التصميم','CAROUSEL','D-CAROUSEL'],['design','قسم التصميم','PANNER','D-PANNER'],['design','قسم التصميم','MOTION','D-MOTION'],['design','قسم التصميم','GIF','D-GIF'],['design','قسم التصميم','PRINT','D-PRINT'],['design','قسم التصميم','MZJ-INTERIAL','D-INTERIAL'],
    ['shooting','قسم التصوير','تصوير صور السياره','P-CAR-PHOTO'],['shooting','قسم التصوير','تصوير ريل - مواصفات - STUDIO','P-RL-SPEC-ST'],['shooting','قسم التصوير','تصوير ريل - SHORT/TREND - SHOWROOM','P-RL-TRD-SR'],['shooting','قسم التصوير','تصوير ريل - UGC - SHOWROOM','P-RL-UGC-SR'],['shooting','قسم التصوير','تصوير ريل - معارضنا - SHOWROOM','P-RL-SHOW-SR'],['shooting','قسم التصوير','تصوير ريل - تجربه عميل - SHOWROOM','P-RL-CUST-SR'],['shooting','قسم التصوير','تصوير فيديو - مواصفات - STUDIO','P-VD-SPEC-ST'],['shooting','قسم التصوير','تصوير فيديو - مواصفات - SHOWROOM','P-VD-SPEC-SR'],['shooting','قسم التصوير','تصوير فيديو - معارضنا - SHOWROOM','P-VD-SHOW-SR'],['shooting','قسم التصوير','تصوير ستوري - سياره - STUDIO','P-ST-CAR-ST'],['shooting','قسم التصوير','تصوير ستوري - معرضنا - SHOWROOM','P-ST-SHOW-SR']
  ].map((x,i)=>({id:'agc-'+(i+1),role:x[0],departmentName:x[1],name:x[2],code:x[3]}));
