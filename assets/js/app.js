...
function fillSettingsForm(){
  ...
  if(document.getElementById('mersalImageTemplate')) mersalImageTemplate.value = mersal.imageTemplate || settings.mersalImageTemplate || 'mzj_image_caption_v3';
...
function bindSettings(){
  ...
  document.getElementById('mersalSettingsForm')?.addEventListener('submit', async event => {
    ...
    const payload = {
      ...
      imageTemplate: normalizeText(document.getElementById('mersalImageTemplate')?.value || 'mzj_image_caption_v3'),
