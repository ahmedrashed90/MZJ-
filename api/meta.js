...
async function handleDebug(req, res) {
  ...
  return json(res, 200, {
    ok: true,
    deployed: 'meta-rewrite-route-fix-v11',
...
async function handlePagesDebug(req, res) {
  ...
  return json(res, 200, { ok: true, connected: true, deployed: 'meta-rewrite-route-fix-v11', me, permissions, directAccounts, nestedAccounts, businesses });
}
...
async function handlePageDirectDebug(req, res) {
  ...
  return json(res, 200, { ok: true, connected: true, deployed: 'meta-rewrite-route-fix-v11', pageId, me, permissions, page, pageFeedRead });
}
...
export default async function handler(req, res) {
  ...
  try {
    ...
    return json(res, 404, { ok: false, error: 'Unknown API route', path, deployed: 'meta-rewrite-route-fix-v11' });
  } catch (error) {
