...
async function handleDebug(req, res) {
  ...
  return json(res, 200, {
    ok: true,
    deployed: 'meta-single-function-vercel-hobby-v9',
...
async function handlePagesDebug(req, res) {
  ...
  return json(res, 200, { ok: true, connected: true, deployed: 'meta-single-function-vercel-hobby-v9', me, permissions, directAccounts, nestedAccounts, businesses });
}
...
async function handlePageDirectDebug(req, res) {
  ...
  return json(res, 200, { ok: true, connected: true, deployed: 'meta-single-function-vercel-hobby-v9', pageId, me, permissions, page, pageFeedRead });
}
...
export default async function handler(req, res) {
  ...
  try {
    ...
    return json(res, 404, { ok: false, error: 'Unknown API route', path, deployed: 'meta-single-function-vercel-hobby-v9' });
  } catch (error) {
